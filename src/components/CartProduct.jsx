...
const CartProduct = ({ itemGroup }) => {
  ...
  return (
    <div className="flex flex-col border-2 border-gray-400 rounded my-4 p-4 w-1/2 items-center justify-center gap-8 shadow-lg hover:shadow-xl transition-shadow">
